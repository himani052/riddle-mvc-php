...
Route::get('/course/play/course/{id}', 'App\controllers\CourseController@play')->name('course.show.play');
Route::post('/course/play/course/{id}', 'App\controllers\CourseController@play')->name('course.show.play');
